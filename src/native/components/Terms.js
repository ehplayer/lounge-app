...
import TermsUser from "./TermsUser"
    ...
    return (
      <Container>
        <Content style={{backgroundColor:'#ffffff'}}>
          ...
          <Left style={{borderBottomWidth:1, width:'100%', borderColor:'#cccccc'}}>
            <Text style={{fontSize:18, height:35, marginLeft:15, paddingBottom:0, color:'#4a4a4a'}}>서비스 이용약관</Text>
          </Left>
          <Left style={{borderBottomWidth:1, height:180, width:'100%', borderColor:'#cccccc', paddingLeft:10, paddingRight:10}}>
            <TermsService/>
          </Left>
          <Button transparent style={{marginLeft:'10%'}} onPress={() => this.handleChange('checkedTermsService', !this.state.checkedTermsService)}>
          <Image
          ...
          <Left style={{borderBottomWidth:1, width:'100%', borderColor:'#cccccc', marginTop:20}}>
            <Text style={{fontSize:18, height:35, marginLeft:15, paddingBottom:0, color:'#4a4a4a'}}>개인정보 제공 및 이용</Text>
          </Left>
          <Left style={{borderBottomWidth:1, height:180, width:'100%', borderColor:'#cccccc', paddingLeft:10, paddingRight:10}}>
            <TermsUser/>
          </Left>
          <Button transparent style={{marginLeft:'10%'}} onPress={() => this.handleChange('checkedTermsUser', !this.state.checkedTermsUser)}>
              <Image
                style={{width: 28, height: 28}}
                resizeMode="contain"
            ...
            <Button transparent style={{marginLeft:'10%'}} onPress={() => this.handleChange('checkedNotification', !this.state.checkedNotification)}>
              <Image
                style={{width: 28, height: 28}}
                resizeMode="contain"
