            ...
            <Container>
                <Content style={{backgroundColor: '#ffffff'}}>
                    ...
                    <Form>
                        ...
                        <Body style={{alignItems: 'center', paddingBottom: 100, flexDirection: 'row'}}>
                        <Button
                            style={{width: 100, justifyContent: 'center', backgroundColor: '#394eb7', marginRight: 5}}
                            onPress={() => this.setState({visibleModal: true})}>
                            <Text>탈퇴</Text>
                        </Button>
                        <Button
                            style={{width: 100, justifyContent: 'center', backgroundColor: '#394eb7', marginLeft: 5}}
                    ...
                    >
                        <View style={loungeStyle.exitModal}>
                            <Text style={{paddingTop: 70, fontSize: 16, fontWeight: '100'}}>정말 탈퇴하시겠습니까?</Text>
                            <Body style={{
                                alignItems: 'center',
                                flexDirection: 'row',
                                paddingTop: 70,
