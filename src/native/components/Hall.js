                                ...
                                <FlatList
                                    ...
                                    renderItem={({item}) => (
                                        <ListItem key={item.articleId} onPress={() => this.openArticle('notice', item)}
                                                  style={{height: 50, paddingLeft: 0, marginLeft: 0, marginRight: 0}}>
                                            <Left style={{marginLeft: 0}}>
                                                <Body style={{marginLeft: 0}}><Text numberOfLines={1}
                                                                                    style={{fontWeight: '100'}}>{item.title}</Text></Body>
                                            </Left>
                                            <Right><Text
                    ...
                    <Card transparent>
                        <CardItem style={{paddingBottom: 0}}>
                            ...
                            <List>
                                ...
                                <ListItem style={{marginLeft: 0, height: 75}}
                                          onPress={() => this.openArticle('schedule', univ.scheduleList[0])}>
                                    <Button transparent style={{
                                        ...
                                        <Text style={{
                                            ...
                                            paddingLeft: 5,
                                            paddingRight: 5
                                        }}>{moment(univ.scheduleList[0].startDatetimeLong).format('MM / DD')}</Text>
                                    </Button>
                                    <Left>
                                        ...
                                        <Text style={{
                                            ...
                                            fontWeight: '100',
                                            marginBottom: 5
                                        }}>{univ.scheduleList[0].title}</Text>
                                        <Text note style={{
                                            paddingTop: 5,
                                            color: boardColor,
                                            fontSize: 13
                                        }}>{'참석 16'} {univ.scheduleList[0].comment && univ.scheduleList[0].comment.length !== 0 ? '댓글 ' + univ.scheduleList[0].comment.length : ''}</Text>
                                        </Body>
                                    </Left>
                                </ListItem>
                                }
                                ...
                                <FlatList
                                    ...
                                    renderItem={({item}) => (
                                        <ListItem key={item.articleId}
                                                  style={{height: 70, paddingLeft: 0, marginLeft: 0}}
                                                  onPress={() => this.openArticle('article', item)}>
                                            <Left>
                                                <Body style={{marginTop: 5}}>
                                                <Text numberOfLines={2}
                                                      style={{fontSize: 15, fontWeight: '100'}}>{item.title}</Text>
